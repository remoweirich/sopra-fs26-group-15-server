...
public class UserControllerTest {
    ...
    @Test
    public void registerUser_validInput_returnsUserAuth() throws Exception {
        User user = new User();
        user.setUserId(1L);
        user.setUserProfile(new UserProfile());
        user.getUserProfile().setUsername("TestUser");
    ...
    @Test
    public void loginUser_validCredentials_returnsUserAuth() throws Exception {
        User user = new User();
        user.setUserId(2L);
